...
namespace IxMilia.Stl
{
    internal class StlWriter
    {
        ...
        {
            return string.Format("{0} {1} {2}", normal.X.ToString(FloatFormat, CultureInfo.InvariantCulture)
        ...
        {
            return string.Format("{0} {1} {2}", vertex.X.ToString(FloatFormat, CultureInfo.InvariantCulture)
